...
# --quality m manim -p rough_work\basic.py SquareToCircle -r 1920,1080
...
"""
manim rough_work\basic.py OpeningManim -r 1920,1080 -ql -fps 60
manim rough_work\basic.py OpeningManim -r 1920,1080 -ql -o rough_work.mp4 -fps 60
...
class SpiralInExample(Scene):
    def construct(self):
        ...
        circle = Circle(color=logo_green, fill_opacity=0.7,
                        stroke_width=0).shift(LEFT)
        square = Square(color=logo_blue, fill_opacity=0.8,
                        stroke_width=0).shift(UP)
