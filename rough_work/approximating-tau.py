...
class ApproximatingTau(VoiceoverScene):
    def construct(self):
        ...
        with self.voiceover(
            ...
            insc_hexa_ex = RegularPolygon(
                6, color=C_INSC_N).scale(3).shift(LEFT * 4)
            csc_hexa_ex = (
            ...
            insc_dodeca_ex = RegularPolygon(
                12, color=C_INSC_N).scale(3).shift(LEFT * 4)
            csc_dodeca_ex = (
            ...
            insc_24_ex = RegularPolygon(
                24, color=C_INSC_N).scale(3).shift(LEFT * 4)
            csc_24_ex = (
            ...
            insc_48_ex = RegularPolygon(
                48, color=C_INSC_N).scale(3).shift(LEFT * 4)
            csc_48_ex = (
            ...
            insc_96_ex = RegularPolygon(
                96, color=C_INSC_N).scale(3).shift(LEFT * 4)
            csc_96_ex = (
        ...
        with self.voiceover(
            ...
            self.play(
                ...
                insc_hexa_side_len.animate.become(
                    MathTex("i_n", color=C_INSC_N).next_to(
                        insc_hexa_side_brace, UP)
                ),
            )
        ...
        with self.voiceover(
            ...
            insc_hexa_side_brace_dest = Brace(
                insc_hexa_side_half, UP, color=C_INSC_N)
        ...
        with self.voiceover(
            ...
            insc_hexa_side_brace_dest = Brace(
                insc_hexa_side_half, DOWN, color=C_INSC_N)
            insc_hexa_side_len_dest = MathTex("i_n/2", color=C_INSC_N).next_to(
            ...
            x_len = MathTex("x", color=C_INSC_2N).shift(
                LEFT * 0.795 + UP * 0.88)
            x_len_part1 = MathTex(
                "= \\sqrt{\\frac{i_n^2}{4} + "
                "\\left( 1 - \\sqrt{1 - "
        ...
        with self.voiceover(
            ...
            self.play(
                Create(csc_hexa), Create(rad2), Write(
                    rad2_brace), Write(rad2_len)
            )
        ...
        with self.voiceover(
            ...
            c6 = MathTex("c_6", "= \\frac{2\\sqrt{3}}{3}").shift(
                RIGHT + UP * 2)
        ...
        with self.voiceover(
            ...
            csc_dodeca_side = Line(
                LEFT * (4 + 3 * (sqrt(6) - sqrt(2)) /
                        (sqrt(6) + sqrt(2))) + UP * 3,
                LEFT * (4 - 3 * (sqrt(6) - sqrt(2)) /
                        (sqrt(6) + sqrt(2))) + UP * 3,
            )
            csc_dodeca_side_brace = Brace(
                csc_dodeca_side, DOWN, color=C_CSC_2N)
        ...
        with self.voiceover(
            ...
            insc_hexa_ind = (
                RegularPolygon(6, stroke_width=6, color=C_IND).scale(
                    3).shift(LEFT * 4)
            )
        ...
        with self.voiceover(
            ...
            self.play(
                Transform(csc_dodeca_side2_half_brace,
        ...
        with self.voiceover(
            ...
            self.play(
                Transform(csc_hexa_side2_half_brace,
        ...
        with self.voiceover(
            ...
            eq_ni_dest.shift(LEFT * 6.5 + RIGHT *
                             eq_ni_dest.width / 2 + UP * 2)
            ...
            self.play(Transform(relation_to_tau, MathTex(
                "ni_n", "< \\tau <", "nc_n")))

            # approximate ni_n and nc_n to two digits after decimal
            self.play(
                Transform(
                    relation_to_tau, MathTex(
                        "6.28\\dots", "< \\tau <", "6.28\\dots")
                )
            )

            # approximate tau to two digits after decimal
            tau_approx = MathTex("\\tau =", "6.28\\dots").next_to(
                relation_to_tau, DOWN)
            self.play(Write(tau_approx))

            # move tau_approx to origin
            self.play(FadeOut(relation_to_tau),
                      tau_approx.animate.move_to(ORIGIN))
